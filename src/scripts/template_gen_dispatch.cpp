...
//#             set out_handle_object_type = gen.genXrObjectType(out_handle_type)
        ...
        RegisterHandleState(handleState->CloneForChild(HandleToInt(* /*{ out_handle_param_name }*/), /*{ out_handle_object_type }*/));
    }
//#         endif
...
//#             set out_handle_param_name = cur_cmd.params[-2].name
        RegisterHandleState(handleState->CloneForChild(HandleToInt(* /*{ out_handle_param_name }*/), XR_OBJECT_TYPE_SWAPCHAIN));
    }
//#         endif
